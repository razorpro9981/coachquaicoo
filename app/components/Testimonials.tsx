...
export default function EnhancedQuotesSection() {
  ...
  return (
    <section className="relative bg-[#F7EFE8] py-24 border-t border-[#EDE0CF]/50 overflow-hidden">
      ...
      <div className="absolute top-10 left-10 w-[400px] h-[400px] bg-[#C17B5C]/5 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute bottom-10 right-10 w-[500px] h-[500px] bg-[#CFCEFE]/8 rounded-full blur-3xl pointer-events-none" />
    ...
    >
      <div className="relative h-full">
        ...
        <div className="relative h-full bg-white/50 backdrop-blur-sm border-2 border-white/80 rounded-xl p-8 shadow-md hover:shadow-xl transition-all duration-500 flex flex-col">
          ...
          <motion.div
            animate={{
              opacity: isHovered ? 1.12 : 0.3,
            }}
            transition={{ duration: 0.5 }}
            className="absolute top-4 right-4 text-6xl font-serif font-light leading-none select-none pointer-events-none"
